...
public class QuestionsLoader {
    ...
    private static final Question[] questions_raw = {
            ...
            new Question("Uznajesz, że bardzo dobrym pomysłem byłoby dofinansowanie i rozpopularyzowanie elektrycznych środków lokomocji. Jednak czy ostatecznie ten pomysł jest dobry? Jeśli się zgodzisz będzie nas to kosztować 30000zł. Jeśli się nie zgodzisz zyskamy 40000zł.", new TreeMap<String, Integer>() {{
                put("environment", 25);
                put("population", 10);
                put("resources", 30);
                put("money", -30000);
            ...
            new Question("Potrzebujemy zaostrzenia reformy dot. utylizacji odpadów i żywności, aby móc ukarać fabryki nieprzestrzegające aktualnych przepisów. Czy zgadzasz się na wprowadzenie jej? Jeśli się zgodzisz będzie nas to kosztować 10000zł. Jeśli się nie zgodzisz zyskamy 5000zł.", new TreeMap<String, Integer>() {{
                put("environment", 20);
                put("food", 15);
                put("population", 5);
                put("resources", 10);
            ...
            new Question("Rada uznała, że warto zachęcić ludzi do prowadzenia bardziej ekologicznego trybu życia dobrą kampanią. Czy zgadzasz się na wprowadzenie jej. Jeśli się zgodzisz będzie nas to kosztować 10000zł. Jeśli się nie zgodzisz zyskamy 15000zł.", new TreeMap<String, Integer>() {{
                put("environment", 20);
                put("food", 10);
                put("population", 5);
                put("resources", 30);
